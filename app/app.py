...
streamlit.write(
    "This decision-support tool is to help Night Owl Real Estate agents explore housing trends and to generate data-driven"
    " starting points for home listing price recommendations."
)
...
streamlit.write("Enter property characteristics to generate a recommended home value.")
